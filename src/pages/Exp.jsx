          ...
          <div style={{ display: "flex", gap: "1rem" }}>
            <div>
              ...
              <p>
                ...
                from IBM Coursera, where I developed a strong foundation in software development, making me able to complete projects like an e-commerce website with the help of several technologies end to end. I developed a client relation where I charged on projects on Fiverr and Upwork, hosting on Render/Netlify if needed. This experience made me improve my progress and never look back on my mentality and focus on progressing. I made large tasks small stepping stones since my journey wasn't an easy one.
                <br /><br />
